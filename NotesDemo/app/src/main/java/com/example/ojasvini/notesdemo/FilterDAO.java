...
public class FilterDAO {
    ...
    public Filter get(long id)
    {
        ...
        Cursor c = db.query(true,FilterTable.TABLENAME,new String[]
                ...
                ,FilterTable.COLUMN_ID + "=?",new String[]{id+""},FilterTable.COLUMN_NAME,null,null,null);
    ...
    public List<Filter> getAll()
    {
        ...
        Cursor c = db.query(true,FilterTable.TABLENAME,new String[]{FilterTable.COLUMN_ID,FilterTable.COLUMN_NAME,FilterTable.COLUMN_IMGURL,FilterTable.COLUMN_PRICE},null,null,FilterTable.COLUMN_NAME,null,null,null);
